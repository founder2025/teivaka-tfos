...
- Last migration: `057_feed_purchased_water` (Phase 6.3-13/14: FEED_PURCHASED + WATER_CONSUMED catalog + audit CHECK extends)
...
- Gate 3 Form Coverage: 15/35 events user-facing (~43%)
