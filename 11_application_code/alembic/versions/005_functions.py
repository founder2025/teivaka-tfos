"""005 - Create PL/pgSQL functions and triggers
Revision ID: 005_functions
Revises: 004_views
...
revision = '005_functions'
down_revision = '004_views'
branch_labels = None
depends_on = None
...
def upgrade():
    _run_sql_file('05_functions.sql')

def downgrade():
    pass  # Functions use CREATE OR REPLACE — re-run upgrade to update
