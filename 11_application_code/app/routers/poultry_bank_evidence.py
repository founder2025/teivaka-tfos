...
async def poultry_bank_evidence(
    ...
    # 6. Hash chain integrity — Migration 132: single source of truth, the
    # corrected seal-aware verifier (chain_seq order, post-seal window). Replaces
    # the inline occurred_at walk that reported false breaks on backdated events.
