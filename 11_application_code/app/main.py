...
app.include_router(farm_libraries.router,     prefix=PREFIX,                         tags=["Farm Libraries"])
...
app.include_router(partners.router,           prefix=PREFIX,                         tags=["Partner Network"])
...
app.include_router(promotions.router,           prefix=PREFIX,                         tags=["Promotions"])
app.include_router(near_you.router,             prefix=PREFIX,                         tags=["Near You"])
