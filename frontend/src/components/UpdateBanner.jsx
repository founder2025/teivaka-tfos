...
export default function UpdateBanner() {
  ...
  return (
    <div style={{ position: "fixed", left: 0, right: 0, bottom: 0, zIndex: 4000, display: "flex", justifyContent: "center", padding: 10, pointerEvents: "none" }}>
      <div style={{ pointerEvents: "auto", background: "#3E7B1F", color: "#fff", borderRadius: 12, padding: "10px 14px", display: "flex", gap: 12, alignItems: "center", boxShadow: "0 6px 18px rgba(58,46,38,.28)" }}>
        <span style={{ fontSize: 13, fontWeight: 600 }}>A new version of TFOS is available.</span>
        <button onClick={() => window.location.reload(true)}
          style={{ background: "#fff", color: "#3E7B1F", fontWeight: 700, fontSize: 13, borderRadius: 8, padding: "6px 12px", border: "none", cursor: "pointer" }}>
          Refresh
        </button>
      </div>
    </div>
