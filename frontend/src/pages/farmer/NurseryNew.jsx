...
export default function NurseryNew() {
  ...
  if (loading) return <div style={{ ...wrap, padding: 32, color: "var(--muted)" }}>Loading…</div>;
  ...
  return (
    <div style={wrap}>
      ...
      <p style={{ color: "var(--muted)", fontSize: 13, marginBottom: 18 }}>Propagation batch — seedlings before they become a field cycle.</p>
