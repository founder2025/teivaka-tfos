          ...
          <div className="space-y-3">
            <div><label className="block text-xs mb-1" style={{ color: C.muted }}>How many birds *</label>
              <input type="number" inputMode="numeric" value={qtySold} onChange={e => setQtySold(e.target.value)} min={1} placeholder="e.g. 50"
                className="w-full px-3 py-3 rounded-md border text-lg" style={{ background: '#fff', borderColor: errs.qty_sold ? C.red : C.border }} />
            ...
            <div><label className="block text-xs mb-1" style={{ color: C.muted }}>Sale type *</label>
              <select value={saleType} onChange={e => setSaleType(e.target.value)} className="w-full px-3 py-3 rounded-md border text-base" style={{ background: '#fff', borderColor: errs.sale_type ? C.red : C.border }}>
