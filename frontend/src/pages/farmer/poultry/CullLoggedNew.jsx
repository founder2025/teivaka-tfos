          ...
          <div className="space-y-3">
            <div>
              ...
              <input type="number" inputMode="numeric" value={qtyCulled} onChange={e => setQtyCulled(e.target.value)} min={1} step={1} placeholder="e.g. 3"
                className="w-full px-3 py-3 rounded-md border text-lg" style={{ background: "var(--paper)", borderColor: errs.qty_culled ? C.red : C.border }} />
            ...
            <div>
              ...
              <select value={disposalMethod} onChange={e => setDisposalMethod(e.target.value)} className="w-full px-3 py-3 rounded-md border text-base" style={{ background: "var(--paper)", borderColor: errs.disposal_method ? C.red : C.border }}>
            ...
            <div>
              ...
              <select value={clearedBy} onChange={e => setClearedBy(e.target.value)} className="w-full px-3 py-3 rounded-md border text-base" style={{ background: "var(--paper)", borderColor: errs.cleared_by ? C.red : C.border }}>
