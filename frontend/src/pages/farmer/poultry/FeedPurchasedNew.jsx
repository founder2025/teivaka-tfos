        ...
        <section style={{ opacity: ready ? 1 : 0.4, pointerEvents: ready ? 'auto' : 'none' }}>
          ...
          <div className="space-y-3">
            <div>
              ...
              <select value={feedId} onChange={e => setFeedId(e.target.value)} className="w-full px-3 py-3 rounded-md border text-base" style={{ background: '#fff', borderColor: errs.feed_id ? C.red : C.border }}>
            ...
            <div>
              ...
              <input type="number" inputMode="decimal" value={costFjd} onChange={e => setCostFjd(e.target.value)} min={0.01} step={0.01} placeholder="e.g. 487.50"
                className="w-full px-3 py-3 rounded-md border text-lg" style={{ background: '#fff', borderColor: errs.cost_fjd ? C.red : C.border }} />
            ...
            <div>
              ...
              <select value={supplierId} onChange={e => setSupplierId(e.target.value)} className="w-full px-3 py-3 rounded-md border text-base" style={{ background: '#fff', borderColor: errs.supplier_id ? C.red : C.border }}>
            ...
            <div>
              ...
              <select value={paymentMethod} onChange={e => setPaymentMethod(e.target.value)} className="w-full px-3 py-3 rounded-md border text-base" style={{ background: '#fff', borderColor: errs.payment_method ? C.red : C.border }}>
            ...
            <div>
              ...
              <input type="text" value={invoiceRef} onChange={e => setInvoiceRef(e.target.value)} maxLength={60} placeholder="e.g. INV-2026-0042"
                className="w-full px-3 py-2 rounded-md border text-sm" style={{ background: '#fff', borderColor: errs.invoice_ref ? C.red : C.border }} />
