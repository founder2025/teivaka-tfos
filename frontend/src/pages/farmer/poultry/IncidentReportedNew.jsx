        ...
        <section style={{ opacity: ready ? 1 : 0.4, pointerEvents: ready ? 'auto' : 'none' }}>
          ...
          <div className="space-y-3">
            <div>
              ...
              <select value={incidentType} onChange={e => setIncidentType(e.target.value)} className="w-full px-3 py-3 rounded-md border text-base" style={{ background: '#fff', borderColor: errs.incident_type ? C.red : C.border }}>
            ...
            <div>
              ...
              <select value={severity} onChange={e => setSeverity(e.target.value)} className="w-full px-3 py-3 rounded-md border text-base" style={{ background: '#fff', borderColor: errs.severity ? C.red : C.border }}>
            ...
            <div>
              ...
              <input type="number" inputMode="numeric" min="0" step="1" value={birdsAffected} onChange={e => setBirdsAffected(e.target.value)} placeholder="0"
                className="w-full px-3 py-3 rounded-md border text-base" style={{ background: '#fff', borderColor: errs.birds_affected_qty ? C.red : C.border }} />
            ...
            <div>
              ...
              <input type="number" inputMode="decimal" min="0" step="0.01" value={estimatedLoss} onChange={e => setEstimatedLoss(e.target.value)} placeholder="45.00"
                className="w-full px-3 py-3 rounded-md border text-base" style={{ background: '#fff', borderColor: errs.estimated_loss_fjd ? C.red : C.border }} />
            ...
            <div>
              ...
              <textarea value={notes} onChange={e => setNotes(e.target.value)} maxLength={500} rows={2} className="w-full px-3 py-2 rounded-md border text-sm" style={{ background: '#fff', borderColor: C.border }} placeholder="What happened?" />
            </div>
          </div>
        </section>
