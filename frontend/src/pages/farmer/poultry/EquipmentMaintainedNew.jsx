        ...
        <section style={{ opacity: ready ? 1 : 0.4, pointerEvents: ready ? 'auto' : 'none' }}>
          ...
          <div className="space-y-3">
            <div>
              ...
              <select value={equipmentType} onChange={e => setEquipmentType(e.target.value)} className="w-full px-3 py-3 rounded-md border text-base" style={{ background: '#fff', borderColor: errs.equipment_type ? C.red : C.border }}>
            ...
            <div>
              ...
              <select value={maintenanceType} onChange={e => setMaintenanceType(e.target.value)} className="w-full px-3 py-3 rounded-md border text-base" style={{ background: '#fff', borderColor: errs.maintenance_type ? C.red : C.border }}>
            ...
            <div>
              ...
              <input type="number" inputMode="decimal" step="0.01" min="0" value={costFjd} onChange={e => setCostFjd(e.target.value)} placeholder="25.50"
                className="w-full px-3 py-3 rounded-md border text-base" style={{ background: '#fff', borderColor: errs.cost_fjd ? C.red : C.border }} />
            ...
            <div>
              ...
              <select value={performedBy} onChange={e => setPerformedBy(e.target.value)} className="w-full px-3 py-3 rounded-md border text-base" style={{ background: '#fff', borderColor: errs.performed_by ? C.red : C.border }}>
            ...
            <div>
              ...
              <textarea value={notes} onChange={e => setNotes(e.target.value)} maxLength={500} rows={2} className="w-full px-3 py-2 rounded-md border text-sm" style={{ background: '#fff', borderColor: C.border }} placeholder="What was done?" />
            </div>
          </div>
        </section>
