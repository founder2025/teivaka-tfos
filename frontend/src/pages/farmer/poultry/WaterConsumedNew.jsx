          ...
          <div className="space-y-3">
            <div>
              ...
              <input type="number" inputMode="decimal" value={qtyLitres} onChange={e => setQtyLitres(e.target.value)} min={0.01} step={0.01} placeholder="e.g. 75"
                className="w-full px-3 py-3 rounded-md border text-lg" style={{ background: '#fff', borderColor: errs.qty_litres ? C.red : C.border }} />
            ...
            <div>
              ...
              <select value={source} onChange={e => setSource(e.target.value)} className="w-full px-3 py-3 rounded-md border text-base" style={{ background: '#fff', borderColor: errs.source ? C.red : C.border }}>
            ...
            <div>
              ...
              <select value={period} onChange={e => setPeriod(e.target.value)} className="w-full px-3 py-3 rounded-md border text-base" style={{ background: '#fff', borderColor: errs.period ? C.red : C.border }}>
